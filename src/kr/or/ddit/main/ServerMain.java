...
import kr.or.ddit.service.blacklist.BlacklistServiceImpl;
...
import kr.or.ddit.service.prodPay.ProdPayServiceImpl;
...
public class ServerMain {
   ...
   public static void main(String[] args) throws RuntimeException{
      ...
      try {
         ...
         BlacklistService bs = BlacklistServiceImpl.getInstance();
         Cart2Service c2s = Cart2ServiceImpl.getInstance();
         ProdPayService pps = ProdPayServiceImpl.getInstance();
