...
public class ReviewBoardServiceImpl extends UnicastRemoteObject implements ReviewBoardService {
	...
	ReviewBoardDaoImpl reviewboardDao;

	public static ReviewBoardServiceImpl service;//Singleton패턴

	public ReviewBoardServiceImpl() throws RemoteException {
		super();
	...
	@Override
	public boolean getReBoardNo(int Rebd_no) throws RemoteException {
		// TODO Auto-generated method stub
